...
| 3 — 크로스인코더 리랭커 | bge-reranker-base (top-K 정렬 정확도) | 🔄 실측 1회 완료 — ctx-prec 0.70→0.80(+0.10)이나 2문항 후퇴·단일실행이라 **채택 보류**(재측정+TOP_K↑ 조건). [`RAG-EVAL-RAGAS §T-rerank A/B`](RAG-EVAL-RAGAS.md) | [`GUIDE-reranker-eval.md`](GUIDE-reranker-eval.md) |
